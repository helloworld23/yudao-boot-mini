...
public interface ReportConvert {
    ...
    default List<ReportDataRespVO> convertDataList(List<ReportDataDO> list, Map<Long, ReportDO> reportMap) {
        return CollectionUtils.convertList(list, def -> convertData(def, reportMap.get(def.getReportId())));
    }
